...
#include "spot_schemas_interfaces/msg/detail/color_label__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = spot_schemas_interfaces::msg::ColorLabel;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const spot_schemas_interfaces::msg::ColorLabel *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<spot_schemas_interfaces::msg::ColorLabel *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ColorLabel__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const spot_schemas_interfaces::msg::ColorLabel *>(
...
static size_t _ColorLabel__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ColorLabel(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ColorLabel__callbacks = {
...
static rosidl_message_type_support_t _ColorLabel__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ColorLabel__callbacks,
...
{
  return &spot_schemas_interfaces::msg::typesupport_fastrtps_cpp::_ColorLabel__handle;
}
