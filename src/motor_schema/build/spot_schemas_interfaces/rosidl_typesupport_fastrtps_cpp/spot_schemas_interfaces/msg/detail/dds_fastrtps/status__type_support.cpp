...
#include "spot_schemas_interfaces/msg/detail/status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const spot_schemas_interfaces::msg::Status & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  spot_schemas_interfaces::msg::Status & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = spot_schemas_interfaces::msg::Status;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const spot_schemas_interfaces::msg::Status *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<spot_schemas_interfaces::msg::Status *>(
    untyped_ros_message);
...
{
  return &spot_schemas_interfaces::msg::typesupport_fastrtps_cpp::_Status__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, spot_schemas_interfaces, msg, Status)() {
  return &spot_schemas_interfaces::msg::typesupport_fastrtps_cpp::_Status__handle;
}
