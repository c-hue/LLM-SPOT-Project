...
bool spot_schemas_interfaces__msg__object2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("spot_schemas_interfaces.msg._object2_d.Object2D", full_classname_dest, 47) == 0);
  }
  spot_schemas_interfaces__msg__Object2D * ros_message = _ros_message;
  {  // object_id
...
PyObject * spot_schemas_interfaces__msg__object2_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("spot_schemas_interfaces.msg._object2_d");
