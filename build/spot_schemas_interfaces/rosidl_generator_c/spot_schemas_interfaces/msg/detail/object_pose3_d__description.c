  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xc4, 0x32, 0x01, 0xff, 0xf0, 0x33, 0x81, 0x85,
      0x99, 0x12, 0xbb, 0xdd, 0x30, 0x9d, 0x7f, 0xc1,
      0x86, 0x09, 0xd5, 0x64, 0x14, 0x94, 0x21, 0x32,
      0x4a, 0x6a, 0xe4, 0x3f, 0xf6, 0x44, 0x00, 0x50,
    }};
  return &hash;
}
...
static char spot_schemas_interfaces__msg__ObjectPose3D__TYPE_NAME[] = "spot_schemas_interfaces/msg/ObjectPose3D";
...
static char spot_schemas_interfaces__msg__ObjectPose3D__FIELD_NAME__pose[] = "pose";
static char spot_schemas_interfaces__msg__ObjectPose3D__FIELD_NAME__object_id[] = "object_id";
static char spot_schemas_interfaces__msg__ObjectPose3D__FIELD_NAME__confidence[] = "confidence";

static rosidl_runtime_c__type_description__Field spot_schemas_interfaces__msg__ObjectPose3D__FIELDS[] = {
  {
    {spot_schemas_interfaces__msg__ObjectPose3D__FIELD_NAME__pose, 4, 4},
    {
  ...
  {
    {spot_schemas_interfaces__msg__ObjectPose3D__FIELD_NAME__object_id, 9, 9},
    {
  ...
  {
    {spot_schemas_interfaces__msg__ObjectPose3D__FIELD_NAME__confidence, 10, 10},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription spot_schemas_interfaces__msg__ObjectPose3D__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {spot_schemas_interfaces__msg__ObjectPose3D__TYPE_NAME, 40, 40},
      {spot_schemas_interfaces__msg__ObjectPose3D__FIELDS, 3, 3},
    },
    {spot_schemas_interfaces__msg__ObjectPose3D__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *spot_schemas_interfaces__msg__ObjectPose3D__get_individual_type_description_source(NULL),
