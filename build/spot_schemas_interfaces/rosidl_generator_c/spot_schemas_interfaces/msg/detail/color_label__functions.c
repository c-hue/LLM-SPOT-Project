...
spot_schemas_interfaces__msg__ColorLabel__init(spot_schemas_interfaces__msg__ColorLabel * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->color_name)) {
    spot_schemas_interfaces__msg__ColorLabel__fini(msg);
    return false;
  }
  return true;
}
...
spot_schemas_interfaces__msg__ColorLabel__create(void)
{
  ...
  spot_schemas_interfaces__msg__ColorLabel * msg = (spot_schemas_interfaces__msg__ColorLabel *)allocator.allocate(sizeof(spot_schemas_interfaces__msg__ColorLabel), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(spot_schemas_interfaces__msg__ColorLabel));
  bool success = spot_schemas_interfaces__msg__ColorLabel__init(msg);
  if (!success) {
...
spot_schemas_interfaces__msg__ColorLabel__Sequence__init(spot_schemas_interfaces__msg__ColorLabel__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_schemas_interfaces__msg__ColorLabel * data = NULL;

  if (size) {
    data = (spot_schemas_interfaces__msg__ColorLabel *)allocator.zero_allocate(size, sizeof(spot_schemas_interfaces__msg__ColorLabel), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = spot_schemas_interfaces__msg__ColorLabel__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        spot_schemas_interfaces__msg__ColorLabel__fini(&data[i - 1]);
      }
...
spot_schemas_interfaces__msg__ColorLabel__Sequence__fini(spot_schemas_interfaces__msg__ColorLabel__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      spot_schemas_interfaces__msg__ColorLabel__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_schemas_interfaces__msg__ColorLabel__Sequence * array = (spot_schemas_interfaces__msg__ColorLabel__Sequence *)allocator.allocate(sizeof(spot_schemas_interfaces__msg__ColorLabel__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = spot_schemas_interfaces__msg__ColorLabel__Sequence__init(array, size);
  if (!success) {
...
spot_schemas_interfaces__msg__ColorLabel__Sequence__destroy(spot_schemas_interfaces__msg__ColorLabel__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    spot_schemas_interfaces__msg__ColorLabel__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
spot_schemas_interfaces__msg__ColorLabel__Sequence__are_equal(const spot_schemas_interfaces__msg__ColorLabel__Sequence * lhs, const spot_schemas_interfaces__msg__ColorLabel__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!spot_schemas_interfaces__msg__ColorLabel__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  spot_schemas_interfaces__msg__ColorLabel__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(spot_schemas_interfaces__msg__ColorLabel);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    spot_schemas_interfaces__msg__ColorLabel * data =
      (spot_schemas_interfaces__msg__ColorLabel *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!spot_schemas_interfaces__msg__ColorLabel__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          spot_schemas_interfaces__msg__ColorLabel__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!spot_schemas_interfaces__msg__ColorLabel__copy(
