...
#include "spot_schemas_interfaces/msg/detail/color_label__rosidl_typesupport_fastrtps_c.h"
...
using _ColorLabel__ros_msg_type = spot_schemas_interfaces__msg__ColorLabel;
...
{
  const _ColorLabel__ros_msg_type * ros_message = static_cast<const _ColorLabel__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = spot_schemas_interfaces__msg__ColorLabel;
    is_plain =
      (
...
static bool _ColorLabel__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const spot_schemas_interfaces__msg__ColorLabel * ros_message = static_cast<const spot_schemas_interfaces__msg__ColorLabel *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_spot_schemas_interfaces__msg__ColorLabel(ros_message, cdr);
}

static bool _ColorLabel__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  spot_schemas_interfaces__msg__ColorLabel * ros_message = static_cast<spot_schemas_interfaces__msg__ColorLabel *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_spot_schemas_interfaces__msg__ColorLabel(cdr, ros_message);
}

static uint32_t _ColorLabel__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_spot_schemas_interfaces__msg__ColorLabel(
      untyped_ros_message, 0));
}

static size_t _ColorLabel__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_spot_schemas_interfaces__msg__ColorLabel(
...
static message_type_support_callbacks_t __callbacks_ColorLabel = {
  "spot_schemas_interfaces::msg",
  "ColorLabel",
  _ColorLabel__cdr_serialize,
  _ColorLabel__cdr_deserialize,
  _ColorLabel__get_serialized_size,
  _ColorLabel__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _ColorLabel__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ColorLabel,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, spot_schemas_interfaces, msg, ColorLabel)() {
  return &_ColorLabel__type_support;
}
